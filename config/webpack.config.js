...
const getPostCSSToVMConfig = require('./pxTovm');
      ...
      },
      {
        ...
        options: {
          ...
          plugins: (loaderContext) => {
            const designWidth = loaderContext.resourcePath.includes(path.join('node_modules', 'antd-mobile')) ? 375 : 750;
            const cssToVm = getPostCSSToVMConfig(designWidth);
            return [
              require('postcss-px-to-viewport')(cssToVm),
        ...
        },
        {
          ...
          oneOf: [
            ...
            // that fall through the other loaders.
            {
              ...
              exclude: [/\.(js|mjs|jsx|ts|tsx)$/, /\.html$/, /\.json$/, path.resolve(__dirname, '../src/assets/svg'), ],
              options: {
                name: 'static/media/[name].[hash:8].[ext]',
              },
            },
